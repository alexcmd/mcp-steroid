...
class CliModeFuzzTest {
    ...
    companion object {
        ...
        fun rejectedInvocations(): Stream<Arguments> = Stream.of(
            ...
            Arguments.of(arrayOf("backend", "download", "idea-community", "--version"), "Missing value for --version"),
            Arguments.of(arrayOf("backend", "download", "idea-community", "--version", "--json"), "Missing value for --version"),
