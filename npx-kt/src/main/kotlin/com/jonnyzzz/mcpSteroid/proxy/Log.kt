...
fun configureLoggingAndLogStarted(homePaths: HomePaths, args: NpxKtArgs) {
    ...
    applyDebugLogging(args.parseDebugFlag())

    val log = logger<NpxKtLog>()
    log.info("Starting NpxKt ${ProxyVersionMetadata.getProxyVersion()} with home paths: $homePaths and $args")
}
